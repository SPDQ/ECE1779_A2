...
if __name__ == "__main__":
    ...
    # parser.add_argument('url', metavar='URL', type=str, default="http://localhost:5000/api/upload",
    #                     help='Base url to upload files to')
    # parser.add_argument('username', metavar='username', type=str, default="admin",
    #                     help='Username')
    # parser.add_argument('password', metavar='password', type=str, default="test",
    #                     help='Password')
    ...
    # parser.add_argument('n_uploads', metavar='N', type=int, nargs='?', default=1,
    ...
    url = "http://1779test-1788742950.us-east-1.elb.amazonaws.com:5000/api/upload"
    rate = 0.7
    files_folder = "C:/Users/Riley Zhao/Documents/UTORONTO/1779/other-A2/ece1779_a2/manage-flaskr/flaskr/aws/test/photos"
    n_uploads = 300
    username = "tester"
    password = "123456"
    loop = asyncio.get_event_loop()
    loop.run_until_complete(load_gen(url, username, password, rate, files_folder, n_uploads))
