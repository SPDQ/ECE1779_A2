...
import pymysql
import boto3
from flask import render_template, session, redirect, url_for, flash, request, jsonify, make_response, g
...
def upload():
    ...
    if request.method == 'POST':
        ...
        # con.close()
        return redirect(
            url_for('detection', filename=filepath, face=output_info["face_num"], unmask=output_info["unmask_num"],
                    mask=output_info["mask_num"]))
